...
import (
	...
	"orion/selfhealing-svc-go/internal/config"
	"orion/selfhealing-svc-go/internal/handler"
	"orion/selfhealing-svc-go/internal/repository"
	"orion/selfhealing-svc-go/internal/service"
	"orion/go-common/pkg/auth"
	"orion/go-common/pkg/database"
	orionlog "orion/go-common/pkg/logger"
	"orion/go-common/pkg/middleware"
	nats_subscriber "orion/selfhealing-svc-go/pkg/nats"
...
func main() {
	logger := orionlog.Must(orionlog.DefaultConfig("orion-selfhealing-svc"))
	defer logger.Sync()
	...
	r.GET("/healthz", middleware.HealthCheck("orion-selfhealing-svc"))
	...
	go func() {
		logger.Info("selfhealing-svc listening", zap.String("addr", addr))
	...
	<-quit
	logger.Info("shutting down selfhealing-svc...")
