...
> **数据校准**: TS 文件数均为源文件数（不含 `dist/`）。pipeline 117（非 351），monitor 39（非 105）。

| 服务 | TS 源文件 | Go 文件 | 差距 | 复杂度 | 预计人天 |
|------|----------|---------|------|--------|---------|
| pipeline | 117 | 115 | 30 域缺失 | 🔴 极高 | 6 |
| monitor | 39 | 20 | 19 域缺失 | 🔴 高 | 4 |
| ai | 76 | 56 | 20 域缺失 | 🟡 中 | 3 |
| security | 43 | 62 | 功能对等 | 🟢 低 | 1 |
| chatops | 81 | 8 (新建) | 新建 stub→完整 | 🟡 中 | 3 |
| code | 52 | 10 (新建) | 新建 stub→完整 | 🟡 中 | 2 |
| audit | 15 | 8 (新建) | 新建 stub→完整 | 🟢 低 | 1 |
| agent | 33 | 12 (新建) | 新建 stub→完整 | 🟡 中 | 1 |
| community | 17 | 10 | 2 路由 vs 14 路由 | 🟡 中 | 1 |
| visor | 11 | 10 | 3 路由 vs 13 路由 | 🟡 中 | 1 |
| pandawiki | 10 | 10 | 0 路由 vs 待确认 | 🟡 中 | 1 |
| 其他 20 个小服务 | 7-27 | 0 | 全部新建 | 🟢 低 | 0.5 每个 |
| 基础设施 orion-db | 4 | 0 | 非微服务, 跳过 | ⚪ 跳过 | — |
