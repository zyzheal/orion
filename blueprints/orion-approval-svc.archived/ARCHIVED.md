...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-approval-svc/` |
| Go destination | `orion-platform-svc-go/internal/approval/` |
| TS files archived | 20 |
...
- **Package**: `orion/platform-svc-go/internal/approval/`
