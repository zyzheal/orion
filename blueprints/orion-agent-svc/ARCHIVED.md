...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-agent-svc/` |
| Go destination | `orion-platform-svc-go/internal/ai-agents/` |
| TS files archived | 33 |
...
- **Package**: `orion/platform-svc-go/internal/ai-agents/`
