...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-user-svc/` |
| Go destination | `orion-platform-svc-go/internal/user/` |
| TS files archived | 0 |
...
- **Package**: `orion/platform-svc-go/internal/user/`
