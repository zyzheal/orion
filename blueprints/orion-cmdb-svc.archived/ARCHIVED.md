...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-cmdb-svc/` |
| Go destination | `orion-platform-svc-go/internal/cmdb/` |
| TS files archived | 8 |
...
- **Package**: `orion/platform-svc-go/internal/cmdb/`
