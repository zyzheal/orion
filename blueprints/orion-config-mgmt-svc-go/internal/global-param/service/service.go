...
import (
	...
	"orion/config-mgmt-svc-go/internal/global-param/models"
	"orion/config-mgmt-svc-go/internal/global-param/repository"
)
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.GlobalParam, error) {
