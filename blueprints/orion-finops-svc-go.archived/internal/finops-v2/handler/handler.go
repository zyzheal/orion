...
import (
	...
	"orion/finops-svc-go/internal/finops-v2/models"
	"orion/finops-svc-go/internal/finops-v2/service"
...
func (h *Handler) Create(c *gin.Context) {
	...
	var req models.CreateFinopsV2Request
...
func (h *Handler) Update(c *gin.Context) {
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
	var req models.UpdateFinopsV2Request
	if err := c.ShouldBindJSON(&req); err != nil {
		respondBadRequest(c, err.Error())
		return
	}
