...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-code-svc/` |
| Go destination | `orion-platform-svc-go/internal/code-repo/` |
| TS files archived | 52 |
...
- **Package**: `orion/platform-svc-go/internal/code-repo/`
