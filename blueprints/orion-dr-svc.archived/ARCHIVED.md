...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-dr-svc/` |
| Go destination | `orion-platform-svc-go/internal/disaster-recovery/` |
| TS files archived | 24 |
...
- **Package**: `orion/platform-svc-go/internal/disaster-recovery/`
