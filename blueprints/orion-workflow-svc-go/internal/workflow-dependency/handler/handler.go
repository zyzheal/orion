...
import (
	...
	"orion/workflow-svc-go/internal/workflow-dependency/service"
...
func (h *Handler) Create(c *gin.Context) {
	...
	var req models.CreateWorkflowDependencyRequest
...
func (h *Handler) Update(c *gin.Context) {
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
	var req models.UpdateWorkflowDependencyRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		respondBadRequest(c, err.Error())
		return
	}
