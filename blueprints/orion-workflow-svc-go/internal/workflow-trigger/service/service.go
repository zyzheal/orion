...
import (
	...
	"orion/workflow-svc-go/internal/workflow-trigger/repository"
)
...
func (s *Service) Get(ctx context.Context, tenantID, id string) (*models.WorkflowTrigger, error) {
	return s.repo.GetByID(ctx, tenantID, id)
}

func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.WorkflowTrigger, error) {
