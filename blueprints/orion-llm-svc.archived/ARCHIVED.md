...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-llm-svc/` |
| Go destination | `orion-platform-svc-go/internal/llm/` |
| TS files archived | 0 |
...
- **Package**: `orion/platform-svc-go/internal/llm/`
