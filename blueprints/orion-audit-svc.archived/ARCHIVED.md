...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-audit-svc/` |
| Go destination | `orion-platform-svc-go/internal/audit/` |
| TS files archived | 30 |
...
- **Package**: `orion/platform-svc-go/internal/audit/`
