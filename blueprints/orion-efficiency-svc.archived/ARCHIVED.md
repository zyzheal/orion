...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-efficiency-svc/` |
| Go destination | `orion-platform-svc-go/internal/efficiency/` |
...
- **Package**: `orion/platform-svc-go/internal/efficiency/`
