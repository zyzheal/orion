...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-risk-svc/` |
| Go destination | `orion-platform-svc-go/internal/risk/` |
| TS files archived | 19 |
...
- **Package**: `orion/platform-svc-go/internal/risk/`
