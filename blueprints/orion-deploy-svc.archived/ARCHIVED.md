...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-deploy-svc/` |
| Go destination | `orion-platform-svc-go/internal/deploy/` |
| TS files archived | 26 |
...
- **Package**: `orion/platform-svc-go/internal/deploy/`
