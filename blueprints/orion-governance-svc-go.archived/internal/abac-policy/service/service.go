...
import (
	...
	"orion/governance-svc-go/internal/abac-policy/repository"
)
...
func (s *Service) Get(ctx context.Context, tenantID, id string) (*models.AbacPolicy, error) {
	return s.repo.GetByID(ctx, tenantID, id)
}

func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.AbacPolicy, error) {
