...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-dba-svc/` |
| Go destination | `orion-platform-svc-go/internal/dba/` |
...
- **Package**: `orion/platform-svc-go/internal/dba/`
