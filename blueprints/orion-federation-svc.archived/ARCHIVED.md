...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-federation-svc/` |
| Go destination | `orion-platform-svc-go/internal/federation/` |
| TS files archived | 22 |
...
- **Package**: `orion/platform-svc-go/internal/federation/`
