...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-visor-svc/` |
| Go destination | `orion-platform-svc-go/internal/visor-exec/` |
| TS files archived | 11 |
...
- **Package**: `orion/platform-svc-go/internal/visor-exec/`
