...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-pipeline-svc/` |
| Go destination | `orion-platform-svc-go/internal/pipeline/` |
| TS files archived | 234 |
...
- **Package**: `orion/platform-svc-go/internal/pipeline/`
