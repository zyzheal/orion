...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-ai-svc/` |
| Go destination | `orion-platform-svc-go/internal/ai/` |
| TS files archived | 76 |
...
- **Package**: `orion/platform-svc-go/internal/ai/`
