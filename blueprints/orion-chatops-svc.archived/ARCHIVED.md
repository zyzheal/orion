...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-chatops-svc/` |
| Go destination | `orion-platform-svc-go/internal/chatops/` |
| TS files archived | 81 |
...
- **Package**: `orion/platform-svc-go/internal/chatops/`
