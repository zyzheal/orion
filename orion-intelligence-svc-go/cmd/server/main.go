...
import (
	...
	"orion/intelligence-svc-go/internal/config"
	"orion/intelligence-svc-go/internal/handler"
	"orion/intelligence-svc-go/internal/repository"
	"orion/intelligence-svc-go/internal/service"
	"orion/go-common/pkg/auth"
	"orion/go-common/pkg/database"
	orionlog "orion/go-common/pkg/logger"
	"orion/go-common/pkg/middleware"
	nats_subscriber "orion/intelligence-svc-go/pkg/nats"
...
func main() {
	logger := orionlog.Must(orionlog.DefaultConfig("orion-intelligence-svc"))
	defer logger.Sync()
	...
	r.GET("/healthz", middleware.HealthCheck("orion-intelligence-svc"))
	...
	go func() {
		logger.Info("intelligence-svc listening", zap.String("addr", addr))
	...
	logger.Info("shutting down intelligence-svc...")
	if natsSub != nil {
