...
func (r *Repository) Create(ctx context.Context, d *models.ChatChannel) error {
	_, err := r.db.ExecContext(ctx, `INSERT INTO chat_commands (id, tenant_id, name, channel, command, response, platform, metadata) VALUES ($1,$2,$3, $4, $5, $6, $7, $8)`, d.ID, d.TenantID, d.Name)
	return err
}
