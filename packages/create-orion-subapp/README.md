...
[![Version](https://img.shields.io/badge/version-1.0.0-blue)](https://github.com/zyzheal/orion-mf)
[![License](https://img.shields.io/badge/license-MIT-blue)](https://github.com/zyzheal/orion-mf/blob/main/LICENSE)
...
主应用使用 `@orion/mf` 加载子应用：

```typescript
import { MFSandboxBridge } from '@orion/mf';
...
---
 ...
 Related: [OrionMF](https://github.com/zyzheal/orion-mf)
