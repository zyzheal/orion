...
func (r *TransferRepository) Create(rec *models.TransferRecord) error {
...
func (r *TransferRepository) ListByTicket(ticketID string) ([]models.TransferRecord, error) {
...
func (r *TransferRepository) GetStats(start, end time.Time) (map[string]any, error) {
