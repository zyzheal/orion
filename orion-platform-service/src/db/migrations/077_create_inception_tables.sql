-- Migration 077: Inception Service Tables
-- SQL audit history and execution tracking via Inception engine
...
-- Rollback:
-- DROP TABLE IF EXISTS audit_reports, inception_configs, sql_blacklist, sql_audit_history;