...
ALTER TABLE canary_traffic_configs ADD COLUMN IF NOT EXISTS tenant_id VARCHAR(255);
...
ALTER TABLE canary_traffic_history ADD COLUMN IF NOT EXISTS tenant_id VARCHAR(255);
CREATE INDEX idx_canary_traffic_history_tenant ON canary_traffic_history(tenant_id);

-- Add tenant_id to federation_executors
ALTER TABLE federation_executors ADD COLUMN IF NOT EXISTS tenant_id VARCHAR(255);
...
ALTER TABLE federation_executor_health ADD COLUMN IF NOT EXISTS tenant_id VARCHAR(255);
