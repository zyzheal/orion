...
describe('FederationController', () => {
  ...
  describe('registerCluster', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.registerCluster(request, reply);
  ...
  describe('listClusters', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listClusters(request, reply);
  ...
  describe('getClusterHealth', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getClusterHealth(request, reply);
  ...
  describe('submitCrossClusterJob', () => {
    it('should handle request and send response', async () => {
      const request = {
        body: { name: 'test', value: 'test-value' },
        params: { id: 'test-id', tenantId: 't-1', userId: 'u-1' },
      ...
      await controller.submitCrossClusterJob(request, reply);
  ...
  describe('getJobStatus', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getJobStatus(request, reply);
