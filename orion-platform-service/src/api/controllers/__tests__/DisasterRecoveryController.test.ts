/**
 * DisasterRecoveryController 单元测试
 */
import { DisasterRecoveryController } from '../DisasterRecoveryController';
...
describe('DisasterRecoveryController', () => {
  let controller: DisasterRecoveryController;

  beforeEach(() => {
    controller = new DisasterRecoveryController();
  });
  ...
  describe('createDRPlan', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.createDRPlan(request, reply);
  ...
  describe('listDRPlans', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listDRPlans(request, reply);
  ...
  describe('executeFailoverTest', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.executeFailoverTest(request, reply);
  ...
  describe('createBackup', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.createBackup(request, reply);
  ...
  describe('executeFailover', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.executeFailover(request, reply);
  ...
  describe('getDRStatus', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getDRStatus(request, reply);
