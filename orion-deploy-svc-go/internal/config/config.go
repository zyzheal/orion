...
func Load() (*Config, error) {
	cfg := Config{
		Server:   ServerConfig{Port: 8087, Mode: "debug"},
		Database: DatabaseConfig{Host: "localhost", Port: 5432, SSLMode: "disable"},
		Otel:     OtelConfig{Enabled: false, Endpoint: "localhost:4318", ServiceName: "orion-deploy-svc"},
	}
	...
	if v := os.Getenv("DEPLOY_SVC_PORT"); v != "" {
