...
import (
	...
	"orion/efficiency-svc-go/internal/config"
	"orion/efficiency-svc-go/internal/handler"
	"orion/efficiency-svc-go/internal/repository"
	"orion/efficiency-svc-go/internal/service"
	nats_subscriber "orion/efficiency-svc-go/pkg/nats"
...
func main() {
	logger := orionlog.Must(orionlog.DefaultConfig("orion-efficiency-svc"))
	defer logger.Sync()
	...
	r.GET("/healthz", middleware.HealthCheck("orion-efficiency-svc"))
	...
	logger.Info("efficiency-svc listening", zap.String("addr", addr))
	...
	logger.Info("shutting down efficiency-svc...")
	if natsSub != nil {
