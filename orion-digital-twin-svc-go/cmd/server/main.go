...
import (
	...
	"orion/digital-twin-svc-go/internal/config"
	"orion/digital-twin-svc-go/internal/handler"
	"orion/digital-twin-svc-go/internal/repository"
	"orion/digital-twin-svc-go/internal/service"
	nats_subscriber "orion/digital-twin-svc-go/pkg/nats"
...
func main() {
	logger := orionlog.Must(orionlog.DefaultConfig("orion-digital-twin-svc"))
	defer logger.Sync()
	...
	r.GET("/healthz", middleware.HealthCheck("orion-digital-twin-svc"))
	...
	logger.Info("digital-twin-svc listening", zap.String("addr", addr))
	...
	logger.Info("shutting down digital-twin-svc...")
	if natsSub != nil {
