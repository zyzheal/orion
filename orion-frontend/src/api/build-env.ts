...
export function createArtifact(data: ArtifactInput) {
  return api.post('/v1/artifacts', data);
}
...
export function downloadArtifact(id: string) {
  return api.get(`/v1/artifacts/${id}/download`, { responseType: 'blob' });
}
...
export function cleanupExpiredArtifacts() {
  return api.post('/v1/artifacts/cleanup/expired');
}
