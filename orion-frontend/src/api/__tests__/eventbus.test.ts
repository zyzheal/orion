...
describe('EventBus API', () => {
  ...
  it('should get eventbus status', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/status');
  ...
  it('should publish an event', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/eventbus/publish', {
      subject: 'test.event',
      data: { key: 'value' },
      tenantId: 'tenant-1',
      publishedBy: 'user-1',
  ...
  it('should get events with filters', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/events?eventType=test&limit=10');
  });
  ...
  it('should get subscriptions', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/subscriptions?tenantId=tenant-1');
  });
  ...
  it('should get stats', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/stats');
  ...
  it('should get jetstream metrics', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/jetstream/metrics');
  ...
  it('should get DLQ events', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/eventbus/dlq?limit=20');
