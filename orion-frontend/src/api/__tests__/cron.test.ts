...
describe('Cron API', () => {
  ...
  it('should get cron jobs', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/cron/jobs');
  ...
  it('should create a cron job', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/cron/jobs', {
      name: 'test',
      schedule: '0 * * * *',
      command: 'cmd',
    });
  ...
  it('should update a cron job', async () => {
    ...
    expect(api.put).toHaveBeenCalledWith('/cron/jobs/1', { name: 'updated' });
  });
  ...
  it('should delete a cron job', async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith('/cron/jobs/1');
  });
  ...
  it('should execute a cron job', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/cron/jobs/1/execute');
  });
  ...
  it('should get cron status', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/cron/status');
