...
describe('LLM Trace API', () => {
  ...
  describe('Trace Operations', () => {
    it('should get trace by ID', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/traces/trace-001');
    ...
    it('should get traces with filters', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/traces', {
  ...
  describe('Statistics', () => {
    it('should get daily stats', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/stats/daily', {
  ...
  describe('Cost Analysis', () => {
    it('should get cost breakdown', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/cost/breakdown', {
    ...
    it('should get tracking accuracy', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/tracking/accuracy');
  ...
  describe('Pricing', () => {
    it('should get pricing table', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/llm/pricing');
    ...
    it('should estimate cost', async () => {
      ...
      expect(api.post).toHaveBeenCalledWith('/llm/cost/estimate', {
        modelId: 'gpt-4',
        inputTokens: 1000,
        outputTokens: 500,
      });
