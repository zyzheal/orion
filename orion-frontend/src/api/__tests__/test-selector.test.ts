...
describe('Test Selector API', () => {
  ...
  it('should get test cases without filters', async () => {
    ...
    await getTestCases();
    expect(api.get).toHaveBeenCalledWith('/test-selector/cases');
  });
  ...
  it('should get test cases with filters', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/test-selector/cases?suite=Auth&status=pass');
  });
  ...
  it('should get test stats', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/test-selector/cases');
    expect(api.get).toHaveBeenCalledWith('/test-selector/suites');
  ...
  it('should run tests', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/test-selector/run', { testIds: ['t1', 't2'] });
