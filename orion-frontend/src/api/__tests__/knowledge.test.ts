...
describe('Knowledge API', () => {
  ...
  it('should get a knowledge item', async () => {
    ...
    expect(api.get).toHaveBeenCalledWith('/knowledge/1');
  ...
  it('should create a knowledge item', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/knowledge', {
      title: 'New',
      content: 'Content',
      category: 'General',
    });
  ...
  it('should update a knowledge item', async () => {
    ...
    expect(api.put).toHaveBeenCalledWith('/knowledge/1', { title: 'Updated' });
  });
