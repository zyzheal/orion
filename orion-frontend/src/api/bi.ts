...
export function getExecutiveDashboard(params?: { days?: number }) {
  return api.get<ExecutiveDashboardData>('/tickets/bi/dashboard/executive', { params });
}
...
export function getManagerDashboard(params?: { teamId?: string; days?: number }) {
  return api.get<ManagerDashboardData>('/tickets/bi/dashboard/manager', { params });
}
...
export function getEngineerDashboard(engineerId: string, params?: { days?: number }) {
  return api.get<EngineerDashboardData>(`/tickets/bi/dashboard/engineer/${engineerId}`, {
    params,
  });
}
