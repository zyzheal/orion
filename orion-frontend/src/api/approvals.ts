...
export function getApproval(id: string) {
  return api.get<ApprovalRequest>(`/v1/approvals/${id}`);
}
...
export function createApproval(data: CreateApprovalInput) {
  return api.post<ApprovalRequest>('/v1/approvals', data);
}
...
export function approveApproval(id: string, data: ApproveRejectInput) {
  return api.post<ApprovalRequest>(`/v1/approvals/${id}/approve`, data);
}
...
export function rejectApproval(id: string, data: ApproveRejectInput) {
  return api.post<ApprovalRequest>(`/v1/approvals/${id}/reject`, data);
}
