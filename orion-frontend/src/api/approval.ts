...
export function getApprovalFlows(params?: {
  ...
  return api.get<ApprovalFlowConfig[]>('/approvals/flows', { params });
}
...
export function getApprovalFlow(id: string) {
  return api.get<ApprovalFlowConfig>(`/approvals/flows/${id}`);
}
...
export function createApprovalFlow(data: CreateApprovalFlowInput) {
  return api.post<ApprovalFlowConfig>('/approvals/flows', data);
}
...
export function updateApprovalFlow(id: string, data: UpdateApprovalFlowInput) {
  return api.put<ApprovalFlowConfig>(`/approvals/flows/${id}`, data);
}
...
export function deleteApprovalFlow(id: string) {
  return api.delete(`/approvals/flows/${id}`);
}
...
export function getApproval(id: string) {
  return api.get<ApprovalChainInfo>(`/approvals/requests/${id}`);
}
...
export function submitApprovalRequest(data: {
  ...
  return api.post<ApprovalChainInfo>('/approvals/requests', data);
}

/**
 * 审批操作 (通用)
 * POST /approvals/requests/:id/review
 */
export function reviewApproval(
  id: string,
  data: { reviewerId: string; action: 'approve' | 'reject'; comment?: string }
) {
  return api.post<ApprovalChainInfo>(`/approvals/requests/${id}/review`, data);
}
...
export function approveRequest(id: string, data: { reviewerId: string; comment?: string }) {
  return api.post<ApprovalChainInfo>(`/approvals/requests/${id}/approve`, data);
}
...
export function rejectRequest(id: string, data: { reviewerId: string; comment?: string }) {
  return api.post<ApprovalChainInfo>(`/approvals/requests/${id}/reject`, data);
}
...
export function getPendingApprovals(params?: { userId?: string; tenantId?: string }) {
  return api.get<ApprovalChainInfo[]>('/approvals/pending', { params });
}
...
export function getApprovalTemplates(params?: { tenantId?: string }) {
  return api.get<ApprovalTemplate[]>('/approvals/templates', { params });
}
...
export function createApprovalTemplate(data: {
  ...
  return api.post<ApprovalTemplate>('/approvals/templates', data);
}
...
/**
 * 获取超时配置列表
 * GET /approvals/timeout-configs
 */
export function getTimeoutConfigs(params?: { resourceType?: string }) {
  return api.get<ApprovalTimeoutConfig[]>('/approvals/timeout-configs', { params });
}

/**
 * 创建超时配置
 * POST /approvals/timeout-configs
 */
export function createTimeoutConfig(
  data: Omit<ApprovalTimeoutConfig, 'id' | 'createdAt' | 'updatedAt'>
) {
  return api.post<ApprovalTimeoutConfig>('/approvals/timeout-configs', data);
}

/**
 * 更新超时配置
 * PUT /approvals/timeout-configs/:id
 */
export function updateTimeoutConfig(
  id: string,
  data: Partial<Omit<ApprovalTimeoutConfig, 'id' | 'createdAt' | 'updatedAt'>>
) {
  return api.put<ApprovalTimeoutConfig>(`/approvals/timeout-configs/${id}`, data);
}

/**
 * 删除超时配置
 * DELETE /approvals/timeout-configs/:id
 */
export function deleteTimeoutConfig(id: string) {
  return api.delete(`/approvals/timeout-configs/${id}`);
}
...
export function requestEmergencyApproval(data: {
  ...
  return api.post<ApprovalChainInfo>('/approvals/emergency', data);
}
...
export function agentAnalyze(data: {
  ...
  return api.post('/approvals/agent/analyze', data);
}
