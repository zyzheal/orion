...
export function fetchRecommendations(context?: { currentPage?: string; resourceId?: string }) {
  return api.post('/chatops/recommendations', { context });
}
...
export function getSessionMessages(
  ...
  return api.get(`/chatops/sessions/${sessionId}/messages`, { params });
}
...
export function getNotificationPreferences() {
  return api.get('/chatops/settings/notification-preferences');
}
...
export function updateNotificationPreferences(data: {
  ...
  return api.put('/chatops/settings/notification-preferences', data);
}
...
export function getDNDSettings() {
  return api.get('/chatops/settings/dnd');
}
...
export function updateDNDSettings(
  ...
  return api.put('/chatops/settings/dnd', data);
}

export function toggleDND(enabled: boolean) {
  return api.patch('/chatops/settings/dnd/toggle', { enabled });
}
...
export function getPlatformConfigs() {
  return api.get('/chatops/settings/platforms');
}

export function updatePlatformConfigs(platforms: PlatformConfig[]) {
  return api.put('/chatops/settings/platforms', { platforms });
}
...
export function getAlertStates() {
  return api.get('/chatops/alerts/states');
}

export function markAlertRead(alertId: string) {
  return api.post(`/chatops/alerts/${alertId}/read`);
}

export function markAlertAcknowledged(alertId: string) {
  return api.post(`/chatops/alerts/${alertId}/acknowledge`);
}

export function markAlertDismissed(alertId: string) {
  return api.post(`/chatops/alerts/${alertId}/dismiss`);
}
...
async function checkBackendHealth(): Promise<{ healthy: boolean; fallback: boolean }> {
  try {
    const response = await fetch('/chatops/health');
    if (!response.ok) {
...
export function connectSSE(options: SSEConnectionOptions): void {
  ...
  function doConnect(): void {
    ...
    try {
      const es = new EventSource('/chatops/stream/recommendations');
...
export function sendChatMessage(data: ChatRequest) {
  return api.post('/chatops/chat', data);
}

export function getAvailableTools() {
  return api.get('/chatops/tools');
}
...
export function getDashboardStats(params?: {
  ...
  return api.get('/chatops/dashboard/stats', { params });
}
...
export function getQuestionConfigs() {
  return api.get('/chatops/settings/questions');
}

export function updateQuestionConfigs(data: { configs: ChatQuestionConfig[] }) {
  return api.put('/chatops/settings/questions', data);
}

export function getCommandConfigs() {
  return api.get('/chatops/settings/commands');
}

export function updateCommandConfigs(data: { configs: ChatCommandConfig[] }) {
  return api.put('/chatops/settings/commands', data);
}
