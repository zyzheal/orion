...
export function getModules(params?: ModuleListParams) {
  return api.get('/v1/iac/modules', { params });
}

export function getModule(id: string) {
  return api.get(`/v1/iac/modules/${id}`);
}

export function createModule(data: ModuleInput) {
  return api.post('/v1/iac/modules', data);
}

export function deleteModule(id: string) {
  return api.delete(`/v1/iac/modules/${id}`);
}
