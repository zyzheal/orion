...
export function analyzeChange(data: ChangeAnalyzeInput) {
  return api.post('/api/change-intelligence/analyze', data);
}

export function getChangeReports(params?: ChangeReportListParams) {
  return api.get('/api/change-intelligence/reports', { params });
}

export function getChangeReportDetail(id: string) {
  return api.get(`/api/change-intelligence/reports/${id}`);
}

export function getBlastRadius(reportId: string) {
  return api.get(`/api/change-intelligence/reports/${reportId}/blast-radius`);
}

export function queryBlastRadius(data: BlastRadiusQueryInput) {
  return api.post('/api/change-intelligence/blast-radius/query', data);
}

export function getChangeTrends(params?: ChangeTrendsParams) {
  return api.get('/api/change-intelligence/trends', { params });
}
