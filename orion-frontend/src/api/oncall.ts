...
export function getSchedules() {
  return api.get<ScheduleListResponse>('/oncall/schedules');
}

export function getSchedule(id: string) {
  return api.get<OnCallSchedule>(`/oncall/schedules/${id}`);
}

export function createSchedule(data: CreateScheduleInput) {
  return api.post<OnCallSchedule>('/oncall/schedules', data);
}

export function deleteSchedule(id: string) {
  return api.delete(`/oncall/schedules/${id}`);
}

// ---- Current On-Call ----

export function getCurrentOnCall(scheduleId: string) {
  return api.get<CurrentOnCallResult>(`/oncall/schedules/${scheduleId}/current`);
}

// ---- Overrides ----

export function createOverride(data: CreateOverrideInput) {
  return api.post<OnCallOverride>('/oncall/overrides', data);
}
