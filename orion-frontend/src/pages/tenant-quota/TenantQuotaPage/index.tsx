        ...
        <Col span={6}>
          <Card>
            ...
            <div style={{ fontSize: 24, fontWeight: 600, color: colors.error[500] }}>
              {alerts.filter((a: QuotaAlert) => a.alertLevel === 'critical').length}
            </div>
          </Card>
        </Col>
      </Row>
        ...
        <Card
          ...
          extra={
            <Space>
              ...
              <Button icon={<ReloadOutlined />} size="small" onClick={loadPlans} loading={loading}>
                刷新
              </Button>
      ...
      >
        {selectedPlan && (
          <Descriptions bordered column={1} size="small">
            ...
            <Descriptions.Item label="API 每分钟">
              {selectedPlan.apiRateLimitPerMin}
            </Descriptions.Item>
            <Descriptions.Item label="API 每小时">
              {selectedPlan.apiRateLimitPerHour}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="最大并发任务">
              {selectedPlan.maxConcurrentJobs}
            </Descriptions.Item>
            <Descriptions.Item label="每日最大告警">
              {selectedPlan.maxAlertsPerDay}
            </Descriptions.Item>
