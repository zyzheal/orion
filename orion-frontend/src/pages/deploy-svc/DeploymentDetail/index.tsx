  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      >
        ...
        <Space>
          <StatusBadge status={deployment.status as 'success' | 'running' | 'failed' | 'pending'} size="medium" />
          {canRollback && (
            <Button
              danger
                  ...
                  >
                    ...
                    >
                      ...
                      <Space>
                        ...
                        <StatusBadge status={stage.status as 'success' | 'running' | 'failed' | 'pending'} size="small" />
                      </Space>
                    </div>
                  </Card>
                ))}
