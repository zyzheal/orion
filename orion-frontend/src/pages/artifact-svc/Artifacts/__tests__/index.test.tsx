...
vi.mock('@/pages/artifact-svc/Artifacts/ArtifactTable', () => ({
...
vi.mock('@/pages/artifact-svc/Artifacts/ArtifactStats', () => ({
  default: ({ stats }: any) => (
...
vi.mock('@/pages/artifact-svc/Artifacts/ArtifactDetail', () => ({
  getArtifactTabItems: () => [],
}));

vi.mock('@/pages/artifact-svc/Artifacts/constants', () => ({
  typeLabelMap: {
