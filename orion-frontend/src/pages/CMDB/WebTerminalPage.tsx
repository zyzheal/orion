  ...
  const initTerminal = useCallback(() => {
    ...
    const term = new Terminal({
      ...
      theme: {
        ...
        brightGreen: colors.terminal.green,
        brightYellow: colors.terminal.yellow,
        brightBlue: colors.terminal.blue,
        brightMagenta: colors.terminal.magenta,
        brightCyan: colors.terminal.cyan,
