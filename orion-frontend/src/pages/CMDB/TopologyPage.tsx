                ...
                >
                  ...
                  <MiniMap
                    nodeColor={(node) => {
                      ...
                      return typeColorMap[d?.type] || colors.primary[500];
                    }}
              ...
              <Descriptions column={1} bordered>
                ...
                <Descriptions.Item label="关系类型">
                  <Tag color={colors.primary[500]}>
                    {((selectedEdge.data as Record<string, unknown>)?.relationType as string) ||
                      selectedEdge.label}
                  </Tag>
                </Descriptions.Item>
                {(selectedEdge.data as Record<string, unknown>)?.relationId ? (
                  <Descriptions.Item label="关系ID">
                    <Text code>
                      {(selectedEdge.data as Record<string, unknown>).relationId as string}
                    </Text>
                  </Descriptions.Item>
                ) : null}
              </Descriptions>
