/**
 * ChaosEngineering Create Experiment Modal
 * 抽取自 index.tsx (P2-9 Phase 132)
 */
import React from 'react';
import { Modal, Alert, Form, Input, Select, Row, Col, InputNumber } from 'antd';
import { ExperimentOutlined } from '@ant-design/icons';
import { colors } from '@/tokens/colors';
import { spacing } from '@/tokens';
import { faultTypeConfig } from '../constants';
import type { ChaosCreateValues } from '../useChaosEngineeringState';
...
interface CreateExperimentModalProps {
  ...
  onCancel: () => void;
  handleCreateExperiment: (values: ChaosCreateValues) => void;
}
