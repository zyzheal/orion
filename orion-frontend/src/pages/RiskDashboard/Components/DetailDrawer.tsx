/**
 * DetailDrawer - 风险评估详情抽屉
 * 抽取自 index.tsx (P2-9 Phase 123)
 */
import React from 'react';
import { Drawer, Descriptions, Timeline, Tag, Typography } from 'antd';
import { colors, spacing } from '@/tokens';
import { riskLevelColor } from '../constants';
...
export const DetailDrawer: React.FC<DetailDrawerProps> = ({ state }) => {
  const { drawerOpen, setDrawerOpen, selectedAssessment } = state;
