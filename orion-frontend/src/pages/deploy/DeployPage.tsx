...
const DeployPage: React.FC = () => {
  ...
  const progressiveColumns = useProgressiveColumns({ openProgressiveDetail, handleAdvanceStage, handleRollbackProgressive });
  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      <DeployModals
        ...
        handleEmergencyDeploy={handleEmergencyDeploy}
        emergencyLoading={emergencyLoading}
        deployWindowModalVisible={deployWindowModalVisible}
        setDeployWindowModalVisible={setDeployWindowModalVisible}
        deployWindowForm={deployWindowForm}
        handleCreateDeployWindow={handleCreateDeployWindow}
        deployWindowSubmitting={deployWindowSubmitting}
        progressiveDeployModalVisible={progressiveDeployModalVisible}
        setProgressiveDeployModalVisible={setProgressiveDeployModalVisible}
        progressiveDeployForm={progressiveDeployForm}
        handleCreateProgressiveDeploy={handleCreateProgressiveDeploy}
        progressiveDeploySubmitting={progressiveDeploySubmitting}
        selectedProgressiveDeploy={selectedProgressiveDeploy}
        progressiveDetailVisible={progressiveDetailVisible}
        setProgressiveDetailVisible={setProgressiveDetailVisible}
        handleAdvanceStage={handleAdvanceStage}
        handleRollbackProgressive={handleRollbackProgressive}
