...
const InstancesTab: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'host',
      key: 'host',
      render: (h: string, r: MiddlewareInstance) => `${h}:${r.port}`,
    },
...
const ConnectionPoolsTab: React.FC = () => {
  ...
  const columns = [
    ...
    { title: '连接池', dataIndex: 'poolName', key: 'poolName' },
    {
      ...
      dataIndex: 'active',
      key: 'active',
      render: (v: number, r: ConnectionPool) => (
        <span style={{ color: v / r.max > 0.8 ? colors.error[500] : colors.neutral[900] }}>
          {v}
        </span>
      ),
    },
    ...
    { title: '最大', dataIndex: 'max', key: 'max' },
    {
      ...
      key: 'waiting',
      render: (v: number) => (
        <span style={{ color: v > 0 ? colors.error[500] : colors.success[500] }}>{v}</span>
      ),
    },
    {
      title: '使用率',
      ...
      render: (_: any, r: ConnectionPool) => (
        <Progress
          percent={Math.round((r.active / r.max) * 100)}
          size="small"
          status={r.active / r.max > 0.8 ? 'exception' : 'normal'}
          style={{ width: 80 }}
        />
      ),
    },
...
const MessageQueuesTab: React.FC = () => {
  ...
  const columns = [
    ...
    { title: '队列名称', dataIndex: 'queueName', key: 'queueName' },
    {
      ...
      key: 'messageCount',
      render: (v: number) => (
        <span style={{ color: v > 10000 ? colors.error[500] : colors.neutral[900] }}>
          {v.toLocaleString()}
        </span>
      ),
    },
        ...
        <Card style={{ marginBottom: spacing.md }}>
          <Row gutter={16} align="middle">
            ...
            <Col span={3}>
              <Statistic
                title="健康"
                value={healthSummary.healthyCount}
            ...
            <Col span={3}>
              <Statistic
                title="降级"
                value={healthSummary.degradedCount}
            ...
            <Col span={3}>
              <Statistic
                title="异常"
                value={healthSummary.unhealthyCount}
