      ...
      memberMetrics: [
        {
          ...
          efficiency: { avgResolutionTimeMs: 3600000, ticketsPerDay: 2.5 },
          quality: { slaComplianceRate: 95, firstTimeResolveRate: 90, reopenRate: 2 },
          compositeScore: 92,
          performanceGrade: 'A',
          trend: 'improving',
        },
        {
          ...
          engineerName: '李娜',
          period: '2026-W15',
          workload: { totalAssigned: 18, totalResolved: 15 },
          efficiency: { avgResolutionTimeMs: 4200000, ticketsPerDay: 2.1 },
          quality: { slaComplianceRate: 88, firstTimeResolveRate: 85, reopenRate: 4 },
          compositeScore: 85,
          performanceGrade: 'B+',
          trend: 'stable',
        },
        {
          ...
          efficiency: { avgResolutionTimeMs: 5400000, ticketsPerDay: 1.7 },
          quality: { slaComplianceRate: 82, firstTimeResolveRate: 78, reopenRate: 6 },
          compositeScore: 78,
          performanceGrade: 'B',
          trend: 'stable',
        },
        {
          ...
          engineerName: '赵敏',
          period: '2026-W15',
          workload: { totalAssigned: 12, totalResolved: 8 },
          efficiency: { avgResolutionTimeMs: 6000000, ticketsPerDay: 1.1 },
          quality: { slaComplianceRate: 70, firstTimeResolveRate: 65, reopenRate: 10 },
          compositeScore: 55,
          performanceGrade: 'D',
          trend: 'declining',
        },
        {
          ...
          engineerName: '孙磊',
          period: '2026-W15',
          workload: { totalAssigned: 10, totalResolved: 7 },
          efficiency: { avgResolutionTimeMs: 7200000, ticketsPerDay: 1.0 },
          quality: { slaComplianceRate: 65, firstTimeResolveRate: 60, reopenRate: 12 },
          compositeScore: 50,
          performanceGrade: 'D',
          trend: 'declining',
        },
