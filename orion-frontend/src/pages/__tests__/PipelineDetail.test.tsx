        ...
        tasks: [
          {
            ...
            status: 'success',
            durationMs: '15000',
            logs: ['Checking out source code...', 'Success: checked out main branch'],
          },
          {
            stageId: 's2',
            stageName: 'Build',
          ...
          },
          {
            ...
            status: 'success',
            durationMs: '60000',
            logs: ['Building project...', 'npm run build', 'Build successful: 120s'],
          },
          {
            stageId: 's3',
            stageName: 'Test',
            ...
            status: 'success',
            durationMs: '90000',
            logs: ['Running tests...', '15 tests passed', 'All tests passed successfully'],
          },
          {
            stageId: 's4',
            stageName: 'Deploy',
