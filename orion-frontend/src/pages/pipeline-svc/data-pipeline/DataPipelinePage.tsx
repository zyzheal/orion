/**
 * Data Pipeline Page (pipeline-svc legacy)
 * Phase 4 - ETL pipeline management, data flow monitoring, and transformation rules
 *
 * Note: This is a legacy page kept for backward compatibility.
 * The main route (/data-pipeline) now points to PipelineManagementPage.
 */
