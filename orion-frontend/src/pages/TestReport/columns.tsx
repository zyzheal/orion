...
export function buildCaseColumns(): any[] {
  return [
    {
      title: '状态',
      dataIndex: 'status',
...
export function buildReportColumns(deps: {
  handleSelectReport: (r: TestReport) => void;
}): any[] {
  const { handleSelectReport } = deps;
  return [
    {
      title: '报告名称',
      dataIndex: 'suiteName',
