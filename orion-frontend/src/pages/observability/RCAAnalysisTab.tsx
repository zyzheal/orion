/**
 * RCAAnalysisTab.tsx - 根因分析 Tab（自包含）
...
const RCAAnalysisTab: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'status',
      width: 100,
      render: (v: string) => <Tag color={STATUS_COLOR_MAP[v]}>{v}</Tag>,
    },
    {
      title: '根因服务',
      key: 'rootCause',
          ...
          <Space direction="vertical" style={{ width: '100%' }} size="middle">
            <Descriptions bordered size="small" column={2}>
              ...
              <Descriptions.Item label="状态">
                <Tag color={STATUS_COLOR_MAP[selectedAnalysis.status]}>
