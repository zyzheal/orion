...
const pageTitleMap: Record<string, { icon: React.ReactNode; title: string; subtitle: string }> = {
  '/console/ai-cost/overview': {
    icon: <BarChartOutlined />,
    title: 'AI 成本总览',
    subtitle: '监控 AI 服务的成本消耗趋势',
  },
  '/console/ai-cost/budgets': {
    icon: <WalletOutlined />,
    title: '预算管理',
    subtitle: '设置和管理 AI 服务预算',
  },
  '/console/ai-cost/details': {
    icon: <UnorderedListOutlined />,
    title: '成本明细',
    subtitle: '查看各项 AI 服务的详细费用',
  },
  '/console/ai-cost/roi': {
    icon: <FundOutlined />,
    title: 'ROI 报告',
  ...
  '/console/ai-cost/alerts': {
    icon: <BellOutlined />,
    title: '告警设置',
    subtitle: '配置成本告警阈值',
  },
  '/console/ai-cost/modules': {
    icon: <PartitionOutlined />,
    title: '模块成本归属',
    subtitle: '按业务场景统计 AI 成本 (TR-09/10/11)',
  },
};
