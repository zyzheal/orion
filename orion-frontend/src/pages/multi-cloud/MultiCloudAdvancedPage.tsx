      ...
      <Row gutter={16} style={{ marginBottom: spacing.lg }}>
        ...
        <Col span={6}>
          ...
          >
            <Statistic
              title="覆盖区域"
              value={Array.from(new Set(accounts.map((a) => a.region))).length}
          ...
          },
          {
            ...
            children: (
              <Card
                ...
                style={{ borderRadius: 12 }}
                extra={
                  <Button icon={<PlusOutlined />} onClick={() => setDrModal(true)}>
                    Create DR Plan
                  </Button>
                }
              >
                  ...
                  <Panel header="Cost Optimization Recommendations" key="recommendations">
                    <Timeline>
                      <Timeline.Item color="green">
                        <strong>Reserved Instances:</strong> Switch to 1-year reserved instances for
                        stable workloads - estimated savings: $3,200/month
                      </Timeline.Item>
                      <Timeline.Item color="blue">
                        <strong>Spot Instances:</strong> Use spot instances for batch processing -
                        estimated savings: $1,800/month
                      </Timeline.Item>
                      <Timeline.Item color="orange">
                        <strong>Right-sizing:</strong> 12 instances are over-provisioned - estimated
                        savings: $900/month
                      </Timeline.Item>
                      <Timeline.Item color="red">
                        <strong>Idle Resources:</strong> 3 unused load balancers detected -
