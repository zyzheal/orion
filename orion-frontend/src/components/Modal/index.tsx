...
const iconMap: Record<ModalType, React.ReactNode> = {
  confirm: <QuestionCircleOutlined style={{ color: colors.warning[500], fontSize: 22 }} />,
  info: <InfoCircleOutlined style={{ color: colors.primary[500], fontSize: 22 }} />,
  error: <CloseCircleOutlined style={{ color: colors.error[500], fontSize: 22 }} />,
  warning: <ExclamationCircleOutlined style={{ color: colors.warning[500], fontSize: 22 }} />,
  success: (
    <span style={{ color: colors.success[500], fontSize: 22 }}>
