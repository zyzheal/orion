...
import (
	...
	"orion-cmdb-svc-go/internal/service-catalog/repository"
)
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.ServiceCatalog, error) {
