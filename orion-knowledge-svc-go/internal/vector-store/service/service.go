...
import (
	...
	"orion/knowledge-svc-go/internal/vector-store/repository"
)
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.VectorStore, error) {
