...
所有技能使用的环境变量定义在 AGENTS.md 的 "Key Environment Variables (Skills CLI Reference)" 章节。技能文件中禁止硬编码路径。
...
| 检查项 | 命令 |
|--------|------|
| 九维完整性 | `grep "九维自检命令" .Codex/skills/*/SKILL.md` |
...
| 版本一致性 | `grep "v2\." .Codex/skills/design-constraint/SKILL.md .Codex/skills/task-decomposer/SKILL.md .Codex/skills/code-design-analyzer/SKILL.md .Codex/skills/design-doc-reviewer/SKILL.md` |
