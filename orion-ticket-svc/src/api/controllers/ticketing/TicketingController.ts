...
import { TicketingService, TicketingServiceError } from '../../../services/TicketingService';
import {
  TicketStatus,
  TicketPriority,
  TicketCategory,
...
export class TicketingController {
  ...
  async createTicket(request: FastifyRequest, reply: FastifyReply) {
    try {
      ...
      const { title, description, category, priority, reporter, tags } = body;
      ...
      // Use PostgreSQL-backed TicketingService
      const input: {
        tenant_id: string;
        title: string;
        description: string;
   ...
   */
  async getAssignmentRules(_request: FastifyRequest, reply: FastifyReply) {
