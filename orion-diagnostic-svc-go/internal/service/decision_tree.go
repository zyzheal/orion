...
func CreateDefaultDecisionTree() *DecisionTree {
	...
	deployNodeBranches = []models.DecisionBranch{
		{
			...
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("CrashLoopBackOff")},
			},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("ImagePullBackOff")},
			},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("Insufficient")},
			},
	...
	pipelineNodeBranches = []models.DecisionBranch{
		{
			...
			Name:  "Test Failures",
			Conditions: []models.DecisionCondition{
				{Field: "type", Operator: "equals", Value: models.JSONB("test_failure")},
			},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("runner")},
				{Field: "severity", Operator: "gte", Value: models.JSONB("error")},
			},
	...
	dbNodeBranches = []models.DecisionBranch{
		{
			...
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("timeout")},
			},
	...
	infraNodeBranches = []models.DecisionBranch{
		{
			...
			Name:  "Disk Full",
			Conditions: []models.DecisionCondition{
				{Field: "description", Operator: "contains", Value: models.JSONB("disk")},
				{Field: "description", Operator: "contains", Value: models.JSONB("full")},
			},
	...
	// Root branches
	tree.rootBranches = []models.DecisionBranch{
		{
			ID:    "root-deploy",
			Name:  "Check Deployment Issues",
			Conditions: []models.DecisionCondition{{Field: "type", Operator: "equals", Value: models.JSONB("deployment_failure")}},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{{Field: "type", Operator: "equals", Value: models.JSONB("pipeline_failure")}},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{{Field: "type", Operator: "any_of", Value: models.JSONB([]string{"node_failure", "resource_exhaustion", "network_issue"})}},
		...
		},
		{
			...
			Conditions: []models.DecisionCondition{{Field: "type", Operator: "any_of", Value: models.JSONB([]string{"database_error", "connection_timeout", "query_failure"})}},
