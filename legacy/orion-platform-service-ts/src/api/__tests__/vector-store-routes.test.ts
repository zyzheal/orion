/**
 * Tests for Vector Store Routes (vector-store-routes.ts)
 *
...
import routePlugin from '../vector-store-routes';
...
describe('Vector Store Routes', () => {
  ...
  describe('POST /search', () => {
    it('should respond to POST /search', async () => {
      const response = await app.inject({
        method: 'POST',
        url: '/search',
        payload: {},
  ...
  describe('DELETE /documents/:id', () => {
    it('should respond to DELETE /documents/:id', async () => {
      const response = await app.inject({
        method: 'DELETE',
