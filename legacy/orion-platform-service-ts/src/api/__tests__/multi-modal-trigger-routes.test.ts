/**
 * Tests for Multi Modal Trigger Routes (multi-modal-trigger-routes.ts)
 *
...
import routePlugin from '../multi-modal-trigger-routes';
...
describe('Multi Modal Trigger Routes', () => {
  ...
  describe('POST /:id/evaluate', () => {
    it('should respond to POST /:id/evaluate', async () => {
      const response = await app.inject({
        method: 'POST',
        url: '/test-id/evaluate',
        payload: {},
        headers: authHeaders,
      });
      expect(response.statusCode).toBeDefined();
