/**
 * DataPipelineController 单元测试
 */
import { DataPipelineController } from '../DataPipelineController';
...
describe('DataPipelineController', () => {
  ...
  beforeEach(() => {
    controller = new DataPipelineController();
  });
  ...
  describe('createPipeline', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.createPipeline(request, reply);
  ...
  describe('listPipelines', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listPipelines(request, reply);
  ...
  describe('executePipeline', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.executePipeline(request, reply);
  ...
  describe('getExecutions', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getExecutions(request, reply);
  ...
  describe('getLineage', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getLineage(request, reply);
  ...
  describe('getSchedule', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getSchedule(request, reply);
  ...
  describe('setSchedule', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.setSchedule(request, reply);
  ...
  describe('getLineageGraph', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getLineageGraph(request, reply);
  ...
  describe('getAllExecutions', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getAllExecutions(request, reply);
