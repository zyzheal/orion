/**
 * DecisionExplanationController 单元测试
 */
import { DecisionExplanationController } from '../DecisionExplanationController';
...
describe('DecisionExplanationController', () => {
  let controller: DecisionExplanationController;

  beforeEach(() => {
    const mockService: any = {};
    controller = new DecisionExplanationController(mockService);
  });
  ...
  describe('explain', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.explain(request, reply);
  ...
  describe('getFeatureImportance', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getFeatureImportance(request, reply);
  ...
  describe('getConfidenceExplanation', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getConfidenceExplanation(request, reply);
    ...
    it('should handle medium level', async () => {
      const request = {
        body: {},
        params: { level: 'medium' },
        query: {},
  ...
  describe('getExplanationById', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getExplanationById(request, reply);
  ...
  describe('getExplanationHistory', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getExplanationHistory(request, reply);
