/**
 * ChangeIntelligenceController 单元测试
 */
import { ChangeIntelligenceController } from '../ChangeIntelligenceController';
...
describe('ChangeIntelligenceController', () => {
  let controller: ChangeIntelligenceController;

  beforeEach(() => {
    const mockService: any = {};
    controller = new ChangeIntelligenceController(mockService);
  });
  ...
  describe('listReports', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listReports(request, reply);
  ...
  describe('getBlastRadius', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getBlastRadius(request, reply);
