/**
 * PipelineVersionController 单元测试
 */
import { PipelineVersionController } from '../PipelineVersionController';
...
describe('PipelineVersionController', () => {
  ...
  beforeEach(() => {
    ...
    controller = new PipelineVersionController(mockVersionService, mockPipelineService);
  });
  ...
  describe('listVersions', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listVersions(request, reply);
  ...
  describe('getVersion', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getVersion(request, reply);
  ...
  describe('diffVersions', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.diffVersions(request, reply);
  ...
  describe('addTag', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.addTag(request, reply);
  ...
  describe('removeTag', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.removeTag(request, reply);
  ...
  describe('setBaseline', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.setBaseline(request, reply);
