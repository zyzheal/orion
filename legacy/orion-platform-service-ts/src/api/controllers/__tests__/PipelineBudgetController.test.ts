/**
 * PipelineBudgetController 单元测试
 */
import { PipelineBudgetController } from '../PipelineBudgetController';
...
describe('PipelineBudgetController', () => {
  let controller: PipelineBudgetController;

  beforeEach(() => {
    const mockBudgetService: any = {};
    const mockPipelineService: any = {};
    controller = new PipelineBudgetController(mockBudgetService, mockPipelineService);
  });
  ...
  describe('estimateBudget', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.estimateBudget(request, reply);
  ...
  describe('getBudgetUsage', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getBudgetUsage(request, reply);
