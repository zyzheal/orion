...
describe('AgentProfileController', () => {
  let controller: AgentProfileController;

  beforeEach(() => {
    const mockService: any = {};
    controller = new AgentProfileController(mockService);
  });
  ...
  describe('toggle', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.toggle(request, reply);
