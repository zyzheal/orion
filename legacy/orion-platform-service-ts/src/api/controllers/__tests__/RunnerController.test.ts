...
describe('RunnerController', () => {
  ...
  beforeEach(() => {
    ...
    controller = new RunnerController(mockService);
  });
  ...
  describe('heartbeat', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.heartbeat(request, reply);
  ...
  describe('deregister', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.deregister(request, reply);
  ...
  describe('listRunners', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listRunners(request, reply);
  ...
  describe('getRunner', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getRunner(request, reply);
  ...
  describe('reportJobResult', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.reportJobResult(request, reply);
