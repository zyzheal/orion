/**
 * PortalDocumentController 单元测试
 */
import { PortalDocumentController } from '../PortalDocumentController';
...
describe('PortalDocumentController', () => {
  let controller: PortalDocumentController;

  beforeEach(() => {
    const mockService: any = {};
    controller = new PortalDocumentController(mockService);
  });
  ...
  describe('getPopular', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getPopular(request, reply);
  ...
  describe('recordHelpful', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.recordHelpful(request, reply);
