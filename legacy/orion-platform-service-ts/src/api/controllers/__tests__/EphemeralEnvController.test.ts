/**
 * EphemeralEnvController 单元测试
 */
import { EphemeralEnvController } from '../EphemeralEnvController';
...
describe('EphemeralEnvController', () => {
  let controller: EphemeralEnvController;

  beforeEach(() => {
    const mockService: any = {};
    controller = new EphemeralEnvController(mockService);
  });
  ...
  describe('wake', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.wake(request, reply);
  ...
  describe('teardown', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.teardown(request, reply);
  ...
  describe('getPreviewUrl', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getPreviewUrl(request, reply);
  ...
  describe('checkHealth', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.checkHealth(request, reply);
  ...
  describe('getCost', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getCost(request, reply);
