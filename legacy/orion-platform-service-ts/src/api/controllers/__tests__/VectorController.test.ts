...
describe('VectorController', () => {
  ...
  beforeEach(() => {
    ...
    controller = new VectorController(mockService);
  });
  ...
  describe('embedCode', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.embedCode(request, reply);
  ...
  describe('searchCode', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.searchCode(request, reply);
  ...
  describe('findSimilarCode', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.findSimilarCode(request, reply);
  ...
  describe('embedDoc', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.embedDoc(request, reply);
  ...
  describe('searchDoc', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.searchDoc(request, reply);
  ...
  describe('batchEmbed', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.batchEmbed(request, reply);
