/**
 * CanaryTrafficController 单元测试
 */
import { CanaryTrafficController } from '../CanaryTrafficController';
...
describe('CanaryTrafficController', () => {
  let controller: CanaryTrafficController;

  beforeEach(() => {
    const mockService: any = {};
    const mockSplitter: any = {};
    controller = new CanaryTrafficController(mockService, mockSplitter);
  });
  ...
  describe('createCanaryDeployment', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.createCanaryDeployment(request, reply);
  ...
  describe('listCanaryDeployments', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.listCanaryDeployments(request, reply);
  ...
  describe('getCanaryDeployment', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.getCanaryDeployment(request, reply);
  ...
  describe('configureTrafficSplit', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.configureTrafficSplit(request, reply);
  ...
  describe('promoteCanary', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.promoteCanary(request, reply);
  ...
  describe('rollbackCanary', () => {
    it('should handle request and send response', async () => {
      ...
      await controller.rollbackCanary(request, reply);
