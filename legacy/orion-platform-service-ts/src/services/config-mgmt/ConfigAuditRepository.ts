/**
 * ConfigAuditRepository - PostgreSQL + memory fallback for config audit entries
 */

import { DatabasePool } from '../database';
import { ConfigAuditEntry, AuditFilter } from './ConfigAuditTypes';
...
export class ConfigAuditRepository {
  ...
  private rowToEntry(row: any): ConfigAuditEntry {
    ...
    return {
      ...
      action: row.action as ConfigAuditEntry['action'],
