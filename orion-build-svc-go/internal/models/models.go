...
// ==================== Builder Image (see builder_image.go) ====================
// Canonical types: BuilderImage, CreateBuilderImageInput, UpdateBuilderImageInput,
// BuilderImageQueryOptions, PresetImageDef, and supporting constants live in
// builder_image.go to avoid duplication.
...
// ==================== Build Cache Config (see build_cache.go) ====================
// Canonical types: BuildCacheConfig, CacheEntry, CreateBuildCacheConfigInput,
// UpdateBuildCacheConfigInput, and supporting constants live in build_cache.go
