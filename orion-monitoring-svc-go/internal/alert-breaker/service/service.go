...
import (
	...
	"orion/monitoring-svc-go/internal/alert-breaker/models"
	"orion/monitoring-svc-go/internal/alert-breaker/repository"
)
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.AlertBreaker, error) {
