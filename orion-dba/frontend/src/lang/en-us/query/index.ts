export default {
  ...
  'query.banner.attion.1':
    'The query operation will be saved for audit purposes',
  'query.banner.attion.2':
    'The maximum limit has been set. If the limit you enter is greater than the maximum limit configured for the platform, the limit configured for the platform prevails',
  'query.banner.attion.3':
    'Only query statements are supported, not non-query statements',
  'query.banner.attion.4':
    'Paste board please use CTRL + Alt + V (Mac Control + Option + V) to open the call ',
  'query.query': 'Query',
  ...
  'query.expire':
    'The query time has expired. Please re-enter the query system',
