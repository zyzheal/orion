...
> **版本**: v1.0 | **数据截至**: 2026-07-19 | **验证方式**: CodeGraph AST分析 + 代码扫描
> ⚠️ v1.0 遗留问题: 维度2 SQL repository数据(61个28%/157个72%)与INDEX v1.1(57个27%/158个73%)存在轻微偏差, 以INDEX v1.1为准
> **P0定义**: 本文档原始P0为"代码级"（编译阻塞/测试失败），统一采用INDEX.md v1.1三阶体系（阻塞级/高优先级/架构缺陷），详见 `docs/review/INDEX.md`
...
> **版本**: v1.0 | **数据截至**: 2026-07-19 | **验证方式**: 代码扫描 + 编译验证
