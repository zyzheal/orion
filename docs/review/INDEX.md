...
> **版本**: v1.1 | **数据截至**: 2026-07-20 | **验证方式**: 实际代码扫描 + `go test ./internal/...`
> v1.0→v1.1 修正: SQL repository 数据(99%→27%), 前端路由数(316→212), 模块数(224→220), 测试结果(34/2→37/3), 添加版本号/数据截止时间/P0定义统一
...
| 指标 | 数值 | 比例 | 更新时间 |
|------|------|------|---------|
| handler.go总数 | 222 | — | 2026-07-20 |
| handler_test.go | 36 | 16% | 2026-07-20 |
| 通过的测试包 | **37** | `go test ./internal/...` ✅ 全部通过 | 2026-07-20 |
| 失败的测试包 | **0** | — | 2026-07-20 |
