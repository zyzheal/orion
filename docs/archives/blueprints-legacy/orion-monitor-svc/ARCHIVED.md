...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-monitor-svc/` |
| Go destination | `orion-platform-svc-go/internal/monitoring/` |
| TS files archived | 72 |
...
- **Package**: `orion/platform-svc-go/internal/monitoring/`
