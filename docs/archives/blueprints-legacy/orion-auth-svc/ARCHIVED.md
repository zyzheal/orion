...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-auth-svc/` |
| Go destination | `orion-platform-svc-go/internal/auth/` |
| TS files archived | 0 |
...
- **Package**: `orion/platform-svc-go/internal/auth/`
