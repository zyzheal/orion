...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-pandawiki-svc/` |
| Go destination | `orion-platform-svc-go/internal/pandawiki/` |
| TS files archived | 10 |
...
- **Package**: `orion/platform-svc-go/internal/pandawiki/`
