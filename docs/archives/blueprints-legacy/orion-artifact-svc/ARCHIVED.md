...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-artifact-svc/` |
| Go destination | `orion-platform-svc-go/internal/artifact/` |
...
- **Package**: `orion/platform-svc-go/internal/artifact/`
