...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-community-svc/` |
| Go destination | `orion-platform-svc-go/internal/community/` |
| TS files archived | 17 |
...
- **Package**: `orion/platform-svc-go/internal/community/`
