...
| Metric | Value |
|--------|-------|
| Original location | `blueprints/orion-plugin-svc/` |
| Go destination | `orion-platform-svc-go/internal/plugin/` |
| TS files archived | 27 |
...
- **Package**: `orion/platform-svc-go/internal/plugin/`
