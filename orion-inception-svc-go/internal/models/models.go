...
type InceptionProject struct {
	...
	Metrics        JSONB  `db:"metrics" json:"metrics,omitempty"`
}

type CreateInceptionProjectRequest struct {
	Name string `json:"name" binding:"required"`

	ExperimentType string `json:"experiment_type" binding:"required"`
