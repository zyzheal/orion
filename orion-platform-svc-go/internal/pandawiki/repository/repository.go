...
// Repository provides PostgreSQL data access for the PandaWiki domain.
...
// ListSpacesOpts filters spaces by type and search term.
...
// ListDocsOpts filters documents by space, status, tag, search, type, source.
