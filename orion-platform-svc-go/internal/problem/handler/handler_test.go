...
func (m *mockSvc) ListKnownErrors(ctx context.Context, tenantID string, filter *models.KnownErrorFilter) ([]models.KnownError, int, error) {
	if m.listKnownErrorsFn != nil { return m.listKnownErrorsFn(ctx, tenantID, filter) }
	return nil, 0, nil
}
func (m *mockSvc) SearchKnownErrors(ctx context.Context, tenantID, query string) ([]models.KnownError, int, error) {
	if m.searchKnownErrorsFn != nil { return m.searchKnownErrorsFn(ctx, tenantID, query) }
	return nil, 0, nil
}
func (m *mockSvc) GetKnownError(ctx context.Context, tenantID, id string) (*models.KnownError, error) {
	if m.getKnownErrorFn != nil { return m.getKnownErrorFn(ctx, tenantID, id) }
	return nil, nil
}
func (m *mockSvc) CreateKnownError(ctx context.Context, tenantID string, req *models.CreateKnownErrorRequest) (*models.KnownError, error) {
	if m.createKnownErrorFn != nil { return m.createKnownErrorFn(ctx, tenantID, req) }
	return nil, nil
}
func (m *mockSvc) UpdateKnownError(ctx context.Context, tenantID, id string, req *models.UpdateKnownErrorRequest) (*models.KnownError, error) {
	if m.updateKnownErrorFn != nil { return m.updateKnownErrorFn(ctx, tenantID, id, req) }
	return nil, nil
}
func (m *mockSvc) DeleteKnownError(ctx context.Context, tenantID, id string) error {
	if m.deleteKnownErrorFn != nil { return m.deleteKnownErrorFn(ctx, tenantID, id) }
	return nil
}
...
func TestHandler_ListProblems_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		listProblemsFn: func(ctx context.Context, tenantID string, filter *models.ProblemFilter) ([]models.Problem, int, error) { return ps, 1, nil },
	})
...
func TestHandler_GetProblem_NotFound(t *testing.T) {
	h := newHandlerWithSvc(&mockSvc{
		getProblemFn: func(ctx context.Context, tenantID, id string) (*models.Problem, error) { return nil, service.ErrNotFound },
	})
...
func TestHandler_CreateProblem_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		createProblemFn: func(ctx context.Context, tenantID string, req *models.CreateProblemRequest) (*models.Problem, error) { return p, nil },
	})
...
func TestHandler_UpdateProblem_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		updateProblemFn: func(ctx context.Context, tenantID, id string, req *models.UpdateProblemRequest) (*models.Problem, error) { return p, nil },
	})
...
func TestHandler_LinkIncident_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		linkIncidentFn: func(ctx context.Context, tenantID, problemID, incidentID string) (*models.Problem, error) { return p, nil },
	})
...
func TestHandler_ListKnownErrors_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		listKnownErrorsFn: func(ctx context.Context, tenantID string, filter *models.KnownErrorFilter) ([]models.KnownError, int, error) { return kes, 1, nil },
	})
...
func TestHandler_SearchKnownErrors_Success(t *testing.T) {
	kes := []models.KnownError{{ID: "ke1"}}
	h := newHandlerWithSvc(&mockSvc{
		searchKnownErrorsFn: func(ctx context.Context, tenantID, query string) ([]models.KnownError, int, error) { return kes, 1, nil },
	})
...
func TestHandler_CreateKnownError_Success(t *testing.T) {
	...
	h := newHandlerWithSvc(&mockSvc{
		createKnownErrorFn: func(ctx context.Context, tenantID string, req *models.CreateKnownErrorRequest) (*models.KnownError, error) { return ke, nil },
	})
