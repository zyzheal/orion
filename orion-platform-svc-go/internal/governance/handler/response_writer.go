...
// respondBadRequestWithDetails writes a BAD_REQUEST with structured details.
func respondBadRequestWithDetails(c *gin.Context, message string, details map[string]any) {
	errors.WriteErrorWithDetails(c, errors.ErrBadRequest, message, http.StatusBadRequest, details)
}
