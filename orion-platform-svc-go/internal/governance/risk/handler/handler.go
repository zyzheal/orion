...
func (h *Handler) Create(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "CreateRisk")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	var req models.CreateRiskItemRequest
...
func (h *Handler) List(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "ListRisks")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Get(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "GetRisk")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Delete(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "DeleteRisk")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Count(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "CountRisks")
	defer span.End()
	tenantID := c.GetString("tenant_id")
