...
// Service handles deployment trigger business logic.
type Service struct {
...
func (s *Service) Create(ctx context.Context, tenantID string, e *models.DeploymentTrigger) (*models.DeploymentTrigger, error) {
...
func (s *Service) Update(ctx context.Context, tenantID, id string, updates map[string]interface{}) (*models.DeploymentTrigger, error) {
