...
import (
    "testing"
    cachemonitor "orion/platform-svc-go/internal/cache-monitor/handler"
)

func TestCacheMonitorHandler_NewHandler(t *testing.T) {
    t.Parallel()
    _ = handler.NewHandler
}

func TestCacheMonitorHandler_RegisterRoutes(t *testing.T) {
    t.Parallel()
