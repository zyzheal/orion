...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	r := rg.Group("/ticket-knowledge")
	r.GET("", auth.RequirePermission("ticket_knowledge", "read"), h.List)
	r.GET("/:id", auth.RequirePermission("ticket_knowledge", "read"), h.Get)
	r.POST("", auth.RequirePermission("ticket_knowledge", "write"), h.Create)
	r.PUT("/:id", auth.RequirePermission("ticket_knowledge", "write"), h.Update)
	r.DELETE("/:id", auth.RequirePermission("ticket_knowledge", "delete"), h.Delete)
}
