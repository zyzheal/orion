...
import (
    "testing"
    codeembedding "orion/platform-svc-go/internal/code-embedding/handler"
)

func TestCodeEmbeddingHandler_NewHandler(t *testing.T) {
    t.Parallel()
    _ = handler.NewHandler
}

func TestCodeEmbeddingHandler_RegisterRoutes(t *testing.T) {
    t.Parallel()
