...
// CodeEmbeddingRepository defines the data access interface for the code-embedding module.
type CodeEmbeddingRepository interface {
...
// CodeEmbeddingService defines the business logic interface for the code-embedding module.
type CodeEmbeddingService interface {
