...
import (
    "testing"
    autorecovery "orion/platform-svc-go/internal/auto-recovery/handler"
)

func TestAutoRecoveryHandler_NewHandler(t *testing.T) {
    t.Parallel()
    _ = handler.NewHandler
}

func TestAutoRecoveryHandler_RegisterRoutes(t *testing.T) {
    t.Parallel()
