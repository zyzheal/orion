...
// AutoRecoveryRepository defines the data access interface for the auto-recovery module.
type AutoRecoveryRepository interface {
...
// AutoRecoveryService defines the business logic interface for the auto-recovery module.
type AutoRecoveryService interface {
