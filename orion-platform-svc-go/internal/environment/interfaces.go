...
// EnvironmentRepository defines the data access interface for the environment module.
...
// EnvironmentService defines the business logic interface for the environment module.
...
// EnvironmentHandler defines the HTTP handler interface for the environment module.
