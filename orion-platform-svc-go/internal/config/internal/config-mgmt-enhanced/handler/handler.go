...
import (
	...
	"orion/platform-svc-go/internal/config/internal/config-mgmt-enhanced/service"
...
func (h *Handler) Create(c *gin.Context) {
	...
	var req models.CreateConfigMgmtEnhancedRequest
...
func (h *Handler) Update(c *gin.Context) {
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
	var req models.UpdateConfigMgmtEnhancedRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		respondBadRequest(c, err.Error())
		return
	}
