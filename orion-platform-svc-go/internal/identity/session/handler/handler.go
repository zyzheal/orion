...
import (
	...
	"orion/platform-svc-go/internal/identity/session/service"
)
...
func (h *Handler) Create(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "CreateSession")
	defer span.End()
...
func (h *Handler) Delete(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "DeleteSession")
	defer span.End()
