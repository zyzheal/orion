...
func (h *PermissionHandler) respondNotFound(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrNotFound, msg, http.StatusNotFound)
}
func (h *PermissionHandler) respondBadRequest(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrBadRequest, msg, http.StatusBadRequest)
}
func (h *PermissionHandler) respondInternalError(c *gin.Context, msg string) {
...
func (h *MFAHandler) respondBadRequest(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrBadRequest, msg, http.StatusBadRequest)
}
func (h *MFAHandler) respondUnauthorized(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrUnauthorized, msg, http.StatusUnauthorized)
}
func (h *MFAHandler) respondForbidden(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrForbidden, msg, http.StatusForbidden)
}
func (h *MFAHandler) respondInternalError(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrInternal, msg, http.StatusInternalServerError)
}
...
func (h *KeyRotationHandler) respondInternalError(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrInternal, msg, http.StatusInternalServerError)
}
...
func (h *LoginAttemptHandler) respondBadRequest(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrBadRequest, msg, http.StatusBadRequest)
}
func (h *LoginAttemptHandler) respondForbidden(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrForbidden, msg, http.StatusForbidden)
}
func (h *LoginAttemptHandler) respondInternalError(c *gin.Context, msg string) {
	errors.WriteError(c, errors.ErrInternal, msg, http.StatusInternalServerError)
}
func (h *LoginAttemptHandler) respondTooManyRequests(c *gin.Context, data map[string]any) {
	c.JSON(http.StatusTooManyRequests, errors.NewErrorEnvelope(c, "", "", data))
}
