...
var ErrNotFound = errors.New("notification-management not found")
...
func (r *Repository) Update(ctx context.Context, tenantID, id string, updates map[string]interface{}) (*models.NotificationManagement, error) {
	if len(updates) == 0 {
