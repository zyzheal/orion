...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	r := rg.Group("/topology")
	r.GET("", auth.RequirePermission("topology", "read"), h.List)
	r.GET("/:id", auth.RequirePermission("topology", "read"), h.Get)
	r.POST("", auth.RequirePermission("topology", "write"), h.Create)
	r.PUT("/:id", auth.RequirePermission("topology", "write"), h.Update)
	r.DELETE("/:id", auth.RequirePermission("topology", "delete"), h.Delete)
}
