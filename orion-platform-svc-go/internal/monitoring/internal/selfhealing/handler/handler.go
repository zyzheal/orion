...
import (
	...
	"orion/platform-svc-go/internal/monitoring/internal/selfhealing/service"
)
...
func (h *SelfHealingHandler) ListActions(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealListActions")
	defer span.End()
	...
	response_writer.Respond(c, http.StatusOK, gin.H{"total": resp.Total, "data": resp.Data})
}

func (h *SelfHealingHandler) CreateAction(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealCreateAction")
	defer span.End()
	tenantID := h.GetTenantID(c)
...
func (h *SelfHealingHandler) GetAction(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealGetAction")
	defer span.End()
	tenantID := h.GetTenantID(c)
...
func (h *SelfHealingHandler) UpdateAction(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealUpdateAction")
	defer span.End()
	tenantID := h.GetTenantID(c)
	id, err := uuid.Parse(c.Param("id"))
	if err != nil {
...
func (h *SelfHealingHandler) DeleteAction(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealDeleteAction")
	defer span.End()
	tenantID := h.GetTenantID(c)
	id, err := uuid.Parse(c.Param("id"))
	if err != nil {
...
func (h *SelfHealingHandler) ExecuteAction(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealExecuteAction")
	defer span.End()
	tenantID := h.GetTenantID(c)
	id, err := uuid.Parse(c.Param("id"))
	if err != nil {
...
func (h *SelfHealingHandler) ListHistory(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "MonitorSelfHealListHistory")
	defer span.End()
	tenantID := h.GetTenantID(c)
