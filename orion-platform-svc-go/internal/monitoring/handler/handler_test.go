...
func (m *mockMonitoringRepo) ListRules(_ context.Context, _ string, _, _ int) ([]models.AlertRule, error) {
	return m.listRules, m.dbErr
}
func (m *mockMonitoringRepo) GetRule(_ context.Context, _, _ string) (*models.AlertRule, error) {
	return m.getRule, m.getRuleErr
}
func (m *mockMonitoringRepo) UpdateRule(_ context.Context, _, _ string, _ map[string]interface{}) error {
	return m.dbErr
}
...
func (m *mockMonitoringRepo) SuppressRule(_ context.Context, _, _ string, _ string, _ *int) error {
	return m.dbErr
}
...
func (m *mockMonitoringRepo) ListAlerts(_ context.Context, _ string, _, _ int) ([]models.Alert, error) {
	return m.listAlerts, m.listAlertsErr
}
...
func (m *mockMonitoringRepo) GetAlert(_ context.Context, _, _ string) (*models.Alert, error) {
	return m.getAlert, m.getAlertErr
}
