...
func (h *Handler) List(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "ListGatewayRoutes")
	defer span.End()
...
func (h *Handler) Get(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "GetGatewayRoute")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Create(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "CreateGatewayRoute")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Delete(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "DeleteGatewayRoute")
	defer span.End()
	tenantID := c.GetString("tenant_id")
