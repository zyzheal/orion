...
import (
	...
	"orion/platform-svc-go/internal/dependency-coordination/repository"
)
...
func (s *Service) Create(ctx context.Context, tenantID string, req *models.CreateDependencyCoordinationRequest) (*models.DependencyCoordination, error) {
	if req == nil || strings.TrimSpace(req.Name) == "" {
		return nil, ErrBadRequest
	}
	item := &models.DependencyCoordination{
		TenantID: tenantID,
		Name:     req.Name,
	}
...
func (s *Service) Get(ctx context.Context, tenantID, id string) (*models.DependencyCoordination, error) {
...
func (s *Service) List(ctx context.Context, tenantID string) ([]models.DependencyCoordination, error) {
	return s.repo.List(ctx, tenantID)
}

func (s *Service) Update(ctx context.Context, tenantID, id string, req *models.UpdateDependencyCoordinationRequest) (*models.DependencyCoordination, error) {
	if req == nil {
		return nil, ErrBadRequest
	}
