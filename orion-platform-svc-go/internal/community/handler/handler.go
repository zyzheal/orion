...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	f := rg.Group("/communities")
	f.GET("", auth.RequirePermission("community", "read"), h.List)
	f.POST("", auth.RequirePermission("community", "write"), h.Create)
	f.GET("/:id", auth.RequirePermission("community", "read"), h.Get)
	f.PUT("/:id", auth.RequirePermission("community", "write"), h.Update)
	f.DELETE("/:id", auth.RequirePermission("community", "delete"), h.Delete)
}
