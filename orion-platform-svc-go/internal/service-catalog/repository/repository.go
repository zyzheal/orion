...
var ErrNotFound = errors.New("service-catalog not found")
...
func (r *Repository) Update(ctx context.Context, tenantID, id string, updates map[string]interface{}) (*models.ServiceCatalog, error) {
	if len(updates) == 0 {
