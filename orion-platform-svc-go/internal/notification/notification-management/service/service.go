...
import (
	...
	"orion/platform-svc-go/internal/notification/notification-management/models"
	"orion/platform-svc-go/internal/notification/notification-management/repository"
)
...
func (s *Service) Create(ctx context.Context, tenantID string, req models.CreateNotificationManagementRequest) (*models.NotificationManagement, error) {
	m := &models.NotificationManagement{
		TenantID: tenantID,
		Name:     req.Name,
	}
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.NotificationManagement, error) {
