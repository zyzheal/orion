...
func NewScheduledNotificationService(_ interface{}, _ interface{}) *ScheduledNotificationService {
...
func (s *Service) GetDelivery(ctx context.Context, tenantID, id string) (*models.NotificationDelivery, error) {
	return nil, nil
}
func (s *Service) GetTemplates(ctx context.Context, tenantID string) ([]models.NotificationTemplate, error) {
	return nil, nil
}
func (s *Service) CreateTemplate(ctx context.Context, tenantID string, t *models.NotificationTemplate) error {
	return nil
}
func (s *Service) GetWorkflow(ctx context.Context, tenantID, id string) (*models.NotificationWorkflowEntity, error) {
	return nil, nil
}
func (s *Service) CreateWorkflow(ctx context.Context, tenantID string, req *models.CreateWorkflowRequest) error {
	return nil
}
func (s *Service) GetPolicy(ctx context.Context, tenantID, id string) (*models.NotificationPolicyEntity, error) {
	return nil, nil
}
func (s *Service) CreatePolicy(ctx context.Context, tenantID string, req *models.CreatePolicyRequest) error {
	return nil
}
func (s *Service) GetScheduledNotifications(ctx context.Context, tenantID string) ([]models.ScheduledNotification, error) {
	return nil, nil
}
func (s *Service) CreateScheduledNotification(ctx context.Context, tenantID string, input *models.CreateScheduledNotificationInput) error {
	return nil
}
func (s *Service) ToggleScheduledNotification(ctx context.Context, tenantID, id string, input *models.ToggleScheduledNotificationInput) error {
	return nil
}
func (s *Service) GetDoNotDisturb(ctx context.Context, tenantID, userID string) (*models.DoNotDisturb, error) {
	return nil, nil
}
func (s *Service) CreateDoNotDisturb(ctx context.Context, tenantID string, input *models.CreateDoNotDisturbInput) error {
	return nil
}
func (s *Service) Broadcast(ctx context.Context, tenantID string, req *models.BroadcastRequest) error {
	return nil
}
func (s *Service) GetDashboardOverview(ctx context.Context, tenantID string) (*models.DashboardOverview, error) {
	return nil, nil
}
func (s *Service) GetWidgets(ctx context.Context, tenantID string) ([]models.DashboardWidget, error) {
	return nil, nil
}
func (s *Service) GetChannels(ctx context.Context, tenantID string) ([]models.NotificationChannel, error) {
	return nil, nil
}
func (s *Service) PreviewTemplate(ctx context.Context, input *models.TemplatePreviewInput) *models.TemplateRenderResult {
	return nil
}
...
func (s *DashboardService) CreateWidget(ctx context.Context, tenantID string, w *models.DashboardWidget) error {
	return nil
}
func (s *DashboardService) GetWidget(ctx context.Context, tenantID, id string) (*models.DashboardWidget, error) {
	return nil, nil
}
func (s *DashboardService) ListWidgets(ctx context.Context, tenantID string) ([]models.DashboardWidget, error) {
	return nil, nil
}
...
func (s *DeliveryService) GetDelivery(ctx context.Context, tenantID, id string) (*models.NotificationDelivery, error) {
	return nil, nil
}
func (s *DeliveryService) ListDeliveries(ctx context.Context, tenantID, notificationID string) ([]models.NotificationDelivery, error) {
	return nil, nil
}

func (s *DNDService) SetDND(ctx context.Context, tenantID, userID string, input *models.CreateDoNotDisturbInput) (*models.DoNotDisturb, error) {
	return nil, nil
}
...
func (s *PolicyService) CreatePolicy(ctx context.Context, tenantID string, req *models.CreatePolicyRequest) (*models.NotificationPolicyEntity, error) {
	return nil, nil
}
...
func (s *PolicyService) CreateWorkflow(ctx context.Context, tenantID string, req *models.CreateWorkflowRequest) (*models.NotificationWorkflowEntity, error) {
	return nil, nil
}
func (s *PolicyService) GetWorkflow(ctx context.Context, id string) (*models.NotificationWorkflowEntity, error) {
	return nil, nil
}
func (s *PolicyService) ListWorkflows(ctx context.Context, tenantID, policyID string) ([]models.NotificationWorkflowEntity, error) {
	return nil, nil
}
...
func (s *ScheduledNotificationService) CreateScheduledNotification(ctx context.Context, tenantID string, input *models.CreateScheduledNotificationInput) (*models.ScheduledNotification, error) {
	return nil, nil
}
...
func (s *ScheduledNotificationService) UpdateScheduledNotification(ctx context.Context, tenantID, id string, input *models.UpdateScheduledNotificationInput) (*models.ScheduledNotification, error) {
	return nil, nil
}
func (s *ScheduledNotificationService) DeleteScheduledNotification(ctx context.Context, tenantID, id string) error {
	return nil
}
func (s *ScheduledNotificationService) ValidateCronExpression(expr string) models.ParsedCronSchedule {
...
func (s *TemplateService) PreviewTemplate(ctx context.Context, input *models.TemplatePreviewInput) *models.TemplateRenderResult {
	return nil
}
