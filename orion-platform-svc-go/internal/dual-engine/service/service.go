...
import (
	...
	"orion/platform-svc-go/internal/dual-engine/repository"
...
func (s *Service) Create(ctx context.Context, tenantID string, req *models.CreateDualEngineRequest) (*models.DualEngine, error) {
	if req == nil || strings.TrimSpace(req.Name) == "" {
		return nil, ErrBadRequest
	}
	item := &models.DualEngine{
		TenantID: tenantID,
		Name:     req.Name,
	}
...
func (s *Service) Get(ctx context.Context, tenantID, id string) (*models.DualEngine, error) {
...
func (s *Service) List(ctx context.Context, tenantID string) ([]models.DualEngine, error) {
	return s.repo.List(ctx, tenantID)
}

func (s *Service) Update(ctx context.Context, tenantID, id string, req *models.UpdateDualEngineRequest) (*models.DualEngine, error) {
	if req == nil {
		return nil, ErrBadRequest
	}
