...
// experimentColumns is what Update may write. created_by is immutable.
var experimentColumns = []string{"name", "description", "scope", "faults", "steady_state_hypothesis", "auto_rollback", "status"}
...
func (r *Repository) Update(ctx context.Context, tenantID, id string, updates map[string]interface{}) error {
	...
	stmt, args, err := dbupdate.Build("chaos_experiments", updates, experimentColumns, id, tenantID)
	if err != nil {
