...
// StatisticsRepository defines the data access interface for the statistics module.
...
// StatisticsService defines the business logic interface for the statistics module.
...
// StatisticsHandler defines the HTTP handler interface for the statistics module.
