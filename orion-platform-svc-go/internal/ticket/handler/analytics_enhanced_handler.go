...
func (h *AnalyticsEnhancedHandler) GetHeatmapData(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketGetHeatmapData")
	defer span.End()
...
func (h *AnalyticsEnhancedHandler) GetBottleneckAnalysis(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketGetBottleneckAnalysis")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsEnhancedHandler) GetCategoryBreakdown(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketGetCategoryBreakdown")
	defer span.End()
...
func (h *AnalyticsEnhancedHandler) GetManagerDashboardEnhanced(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketGetManagerDashboardEnhanced")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
...
func (h *AnalyticsEnhancedHandler) GetEngineerDashboardEnhanced(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketGetEngineerDashboardEnhanced")
	defer span.End()
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
