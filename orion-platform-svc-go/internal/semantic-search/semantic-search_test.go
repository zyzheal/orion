...
import (
    "testing"
    semanticsearch "orion/platform-svc-go/internal/semantic-search/handler"
)

func TestSemanticSearchHandler_NewHandler(t *testing.T) {
    t.Parallel()
    _ = handler.NewHandler
}

func TestSemanticSearchHandler_RegisterRoutes(t *testing.T) {
    t.Parallel()
