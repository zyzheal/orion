...
func (e *SemanticSearchError) Is(target error) bool {
	_, ok := target.(*SemanticSearchError)
	return ok
}
...
func NewSemanticSearchError(code, msg string) error {
	return &SemanticSearchError{Code: code, Message: msg}
}
