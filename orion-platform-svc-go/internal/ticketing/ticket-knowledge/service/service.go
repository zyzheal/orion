...
import (
	...
	"orion/platform-svc-go/internal/ticketing/ticket-knowledge/repository"
)
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.TicketKnowledge, error) {
