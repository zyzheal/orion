...
import (
	...
	"orion/platform-svc-go/internal/ticketing/ticket-knowledge/service"
...
func (h *Handler) Create(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTKCreate")
	defer span.End()
...
func (h *Handler) Get(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTKGet")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
...
func (h *Handler) List(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTKList")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *Handler) Update(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTKUpdate")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
...
func (h *Handler) Delete(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTKDelete")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
