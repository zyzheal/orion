...
func (h *RelationHandler) AddRelation(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingAddRelation")
	defer span.End()
	ticketID := c.Param("id")
...
func (h *RelationHandler) GetRelations(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetRelations")
	defer span.End()
...
func (h *RelationHandler) FindRelatedTickets(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingFindRelatedTickets")
	defer span.End()
...
func (h *RelationHandler) DetectDuplicates(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingDetectDuplicates")
	defer span.End()
...
func (h *RelationHandler) CorrelateRootCause(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingCorrelateRootCause")
	defer span.End()
	var req struct {
