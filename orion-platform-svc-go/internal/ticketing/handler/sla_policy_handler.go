...
func (h *SLAPolicyHandler) CreatePolicy(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingCreatePolicy")
	defer span.End()
...
func (h *SLAPolicyHandler) ListPolicies(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingListPolicies")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *SLAPolicyHandler) GetPolicy(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetPolicy")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *SLAPolicyHandler) UpdatePolicy(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingUpdatePolicy")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	policyID := c.Param("policyId")
...
func (h *SLAPolicyHandler) DeletePolicy(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingDeletePolicy")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	policyID := c.Param("policyId")
...
func (h *SLAPolicyHandler) GetPolicyCompliance(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetPolicyCompliance")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	policyID := c.Param("policyId")
...
func (h *SLAPolicyHandler) GetTicketSLAStatus(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetTicketSLAStatus")
	defer span.End()
	tenantID := c.GetString("tenant_id")
