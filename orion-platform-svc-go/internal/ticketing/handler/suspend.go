...
func (h *SuspendHandler) CreateSuspend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingCreateSuspend")
	defer span.End()
...
func (h *SuspendHandler) ActivateSuspend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingActivateSuspend")
	defer span.End()
...
func (h *SuspendHandler) EndSuspend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingEndSuspend")
	defer span.End()
...
func (h *SuspendHandler) CancelSuspend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingCancelSuspend")
	defer span.End()
...
func (h *SuspendHandler) ListSuspensions(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingListSuspensions")
	defer span.End()
...
func (h *SuspendHandler) GetSuspend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetSuspend")
	defer span.End()
...
func (h *SuspendHandler) GetEngineerSuspensions(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetEngineerSuspensions")
	defer span.End()
...
func (h *SuspendHandler) GetEngineerSuspendImpact(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetEngineerSuspendImpact")
	defer span.End()
