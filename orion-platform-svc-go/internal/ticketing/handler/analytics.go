...
func (h *AnalyticsHandler) GetStatistics(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetStatistics")
	defer span.End()
...
func (h *AnalyticsHandler) GetResolutionStats(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetResolutionStats")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetBacklogAnalysis(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetBacklogAnalysis")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetTrendReport(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetTrendReport")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetExecutiveDashboard(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetExecutiveDashboard")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetManagerDashboard(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetManagerDashboard")
	defer span.End()
	tenantID := c.GetString("tenant_id")
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
...
func (h *AnalyticsHandler) GetEngineerDashboard(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetEngineerDashboard")
	defer span.End()
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
...
func (h *AnalyticsHandler) GetEfficiencyScore(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetEfficiencyScore")
	defer span.End()
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
...
func (h *AnalyticsHandler) ComparePeriods(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingComparePeriods")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) ExportBIData(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingExportBIData")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetTimeTrend(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetTimeTrend")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) TransferTicket(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingTransferTicket")
	defer span.End()
	tenantID := c.GetString("tenant_id")
...
func (h *AnalyticsHandler) GetTransferHistory(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetTransferHistory")
	defer span.End()
...
func (h *AnalyticsHandler) GetTransferStats(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "TicketingGetTransferStats")
	defer span.End()
	start := parseTime(c.Query("periodStart"))
	end := parseTime(c.Query("periodEnd"))
