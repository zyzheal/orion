...
// respondRateLimited writes a canonical RATE_LIMITED error envelope.
func respondRateLimited(c *gin.Context, message string) {
	errors.WriteError(c, errors.ErrBadRequest, message, http.StatusTooManyRequests)
}
