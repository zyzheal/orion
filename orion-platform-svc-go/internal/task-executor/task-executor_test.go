...
import (
    "testing"
    taskexecutor "orion/platform-svc-go/internal/task-executor/handler"
)

func TestTaskExecutorHandler_NewHandler(t *testing.T) {
    t.Parallel()
    _ = handler.NewHandler
}

func TestTaskExecutorHandler_RegisterRoutes(t *testing.T) {
    t.Parallel()
