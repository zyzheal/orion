...
func (s *Service) Create(ctx context.Context, tenantID string, req *models.CreateDecisionExplanationRequest) (*models.DecisionExplanation, error) {
	if req == nil || strings.TrimSpace(req.Name) == "" {
		return nil, ErrBadRequest
	}
	item := &models.DecisionExplanation{
		TenantID: tenantID,
		Name:     req.Name,
	}
...
func (s *Service) List(ctx context.Context, tenantID string) ([]models.DecisionExplanation, error) {
	return s.repo.List(ctx, tenantID)
}

func (s *Service) Update(ctx context.Context, tenantID, id string, req *models.UpdateDecisionExplanationRequest) (*models.DecisionExplanation, error) {
	if req == nil {
		return nil, ErrBadRequest
	}
