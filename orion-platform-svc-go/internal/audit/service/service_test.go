...
func TestAuditCreate_DefaultTenantID(t *testing.T) {
	...
	if req.TenantID != "t1" {
		t.Errorf("expected t1, got %s", req.TenantID)
	}
}
...
func TestAuditCreate_DefaultResourceType(t *testing.T) {
	...
	if req.ResourceType != "audit" {
		t.Errorf("expected audit, got %s", req.ResourceType)
	}
}
...
func TestMockAuditRepoGetByID_Success(t *testing.T) {
	...
	if got.Action != "CREATE" {
		t.Errorf("expected CREATE, got %s", got.Action)
	}
}
...
func TestAuditList_TotalPagesZero(t *testing.T) {
	...
	totalPages := (total + limit - 1) / limit
	if totalPages != 0 {
		t.Errorf("expected 0 pages, got %d", totalPages)
	}
	if totalPages == 0 {
		totalPages = 1
	}
	if totalPages != 1 {
		t.Errorf("expected 1 page (default), got %d", totalPages)
	}
}
...
func TestMockAuditRepoVerifyChain_Success(t *testing.T) {
	...
	if verified != 2 {
		t.Errorf("expected 2, got %d", verified)
	}
	if !valid {
...
func TestMockAuditRepoVerifyChain_Empty(t *testing.T) {
	...
	if verified != 0 {
		t.Errorf("expected 0, got %d", verified)
	}
	if !valid {
...
func TestMockAuditRepoGetActions_Success(t *testing.T) {
	...
	if len(actions) != 2 {
		t.Errorf("expected 2, got %d", len(actions))
	}
}
...
func TestGenesisHash(t *testing.T) {
	...
	if GenesisHash != expected {
		t.Errorf("expected %s, got %s", expected, GenesisHash)
	}
}
