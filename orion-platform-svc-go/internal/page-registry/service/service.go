...
func (s *Service) Get(ctx context.Context, tenantID, id string) (*models.PageRegistry, error) {
	return s.repo.GetByID(ctx, tenantID, id)
}

func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.PageRegistry, error) {
	return s.repo.List(ctx, tenantID, limit, offset)
}

func (s *Service) Update(ctx context.Context, tenantID, id string, req models.UpdatePageRegistryRequest) (*models.PageRegistry, error) {
