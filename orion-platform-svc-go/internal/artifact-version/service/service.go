...
import (
    ...
    "orion/platform-svc-go/internal/artifact-version/repository"
)
...
func (s *Service) AddTag(ctx context.Context, tenantID, id string) (*models.Record, error) {
    return nil, nil
}
...
// ---- Slice-returning service methods ----
...
// ---- Action service methods (return gin.H{"status": "ok"}) ----
