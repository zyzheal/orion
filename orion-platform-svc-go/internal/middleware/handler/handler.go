...
func (h *Handler) RegisterRateLimit(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "RegisterRateLimit")
	defer span.End()
...
func (h *Handler) UpdateMiddleware(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "UpdateMiddleware")
	defer span.End()
...
func (h *Handler) SetTimeout(c *gin.Context) {
	ctx, span := otel.Tracer("orion-platform-svc").Start(c.Request.Context(), "SetMiddlewareTimeout")
	defer span.End()
	var req struct {
