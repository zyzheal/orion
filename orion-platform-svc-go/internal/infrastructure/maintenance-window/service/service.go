...
import (
	...
	"orion/platform-svc-go/internal/infrastructure/maintenance-window/repository"
)
...
func (s *Service) Create(ctx context.Context, tenantID string, req models.CreateMaintenanceWindowRequest) (*models.MaintenanceWindow, error) {
	m := &models.MaintenanceWindow{TenantID: tenantID, Name: req.Name}
...
func (s *Service) List(ctx context.Context, tenantID string, limit, offset int) ([]models.MaintenanceWindow, error) {
