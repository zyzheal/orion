...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	r := rg.Group("/message-queue")
	r.GET("", auth.RequirePermission("message_queue", "read"), h.List)
	r.GET("/:id", auth.RequirePermission("message_queue", "read"), h.Get)
	r.POST("", auth.RequirePermission("message_queue", "write"), h.Create)
	r.PUT("/:id", auth.RequirePermission("message_queue", "write"), h.Update)
	r.DELETE("/:id", auth.RequirePermission("message_queue", "delete"), h.Delete)
}
