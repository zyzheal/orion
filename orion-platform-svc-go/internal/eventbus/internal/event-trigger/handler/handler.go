...
import (
	...
	"orion/platform-svc-go/internal/eventbus/internal/event-trigger/service"
...
func (h *Handler) Create(c *gin.Context) {
	...
	var req models.CreateEventTriggerRequest
...
func (h *Handler) Update(c *gin.Context) {
	tenantID := c.GetString("tenant_id")
	id := c.Param("id")
	var req models.UpdateEventTriggerRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		respondBadRequest(c, err.Error())
		return
	}
