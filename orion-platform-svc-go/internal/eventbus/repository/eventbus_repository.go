...
// EventBusRepository provides data access for the Event Bus domain.
type EventBusRepository struct {
	db *sqlx.DB
}

// NewEventBusRepository creates a new EventBusRepository instance.
func NewEventBusRepository(db *sqlx.DB) *EventBusRepository {
...
func (r *EventBusRepository) Subscribe(ctx context.Context, tenantID, eventType, handler string) (*models.EventSubscription, error) {
...
func (r *EventBusRepository) Unsubscribe(ctx context.Context, tenantID, id string) (bool, error) {
...
func (r *EventBusRepository) UpdateSubscriptionEnabled(ctx context.Context, tenantID, id string, enabled bool) (*models.EventSubscription, error) {
	var sub models.EventSubscription
	err := r.db.QueryRowxContext(ctx,
...
func (r *EventBusRepository) GetSubscriptions(ctx context.Context, tenantID string, eventType *string) ([]models.EventSubscription, error) {
...
func (r *EventBusRepository) GetSubscriptionByID(ctx context.Context, tenantID, id string) (*models.EventSubscription, error) {
	var sub models.EventSubscription
...
func (r *EventBusRepository) CountSubscriptions(ctx context.Context, tenantID string) (int, error) {
	var count int
...
func (r *EventBusRepository) LogEvent(ctx context.Context, tenantID, eventType, subject, source, publishedBy string, payload models.JSONB) (*models.EventLog, error) {
...
func (r *EventBusRepository) GetEventLogs(ctx context.Context, tenantID string, limit int) ([]models.EventLog, error) {
...
func (r *EventBusRepository) GetEventLogByID(ctx context.Context, tenantID, id string) (*models.EventLog, error) {
	var log models.EventLog
...
func (r *EventBusRepository) UpdateEventStatus(ctx context.Context, id string, status models.EventStatus) (*models.EventLog, error) {
	var log models.EventLog
	err := r.db.QueryRowxContext(ctx,
...
func (r *EventBusRepository) FindPendingFallbackEvents(ctx context.Context, limit int, maxRetryCount int) ([]models.EventLog, error) {
	var logs []models.EventLog
	err := r.db.SelectContext(ctx, &logs,
		`SELECT id, tenant_id, event_type, subject, source, payload, sequence_num, status, published_by, published_at, retry_count, last_retry_at, processed, created_at
		 FROM event_logs
...
func (r *EventBusRepository) IncrementRetryCount(ctx context.Context, id string) (*models.EventLog, error) {
	var log models.EventLog
	err := r.db.QueryRowxContext(ctx,
		`UPDATE event_logs
...
func (r *EventBusRepository) CountByStatus(ctx context.Context, status models.EventStatus) (int, error) {
	var count int
	err := r.db.GetContext(ctx, &count,
...
func (r *EventBusRepository) CountByType(ctx context.Context, eventType string) (int, error) {
	var count int
...
func (r *EventBusRepository) MarkEventProcessed(ctx context.Context, tenantID, id string) error {
...
// ---------- EventBusConfig operations ----------

// FindConfigByKey returns a config entry by its key.
func (r *EventBusRepository) FindConfigByKey(ctx context.Context, key string) (*models.EventBusConfig, error) {
...
func (r *EventBusRepository) UpsertConfig(ctx context.Context, key string, value models.JSONB, description *string) (*models.EventBusConfig, error) {
	var cfg models.EventBusConfig
	err := r.db.QueryRowxContext(ctx,
...
func (r *EventBusRepository) GetAllConfigs(ctx context.Context) ([]models.EventBusConfig, error) {
