...
CREATE INDEX IF NOT EXISTS idx_eval_sets_tenant_eval_sets ON eval_sets(tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_eval_set_cases_set_eval_set_cases ON eval_set_cases(set_id);